  ...
  themeConfig: {
    ...
    footer: {
      links: [
        ...
        {
          html: `
            <a href="https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=MzkxMzUyMzU4OQ==&scene=124#wechat_redirect" target="_blank" rel="noopener noreferrer" aria-label="WeChat">
